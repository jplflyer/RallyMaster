...
public class DtoMapper {
    public static UiRally toUiRally(
        ...
        return UiRally
                ...
                .isPublic(isOrganizer ? rally.getIsPublic() : null)
    ...
    public static UiRide toUiRide(Ride ride) {
        ...
        return UiRide
                ...
                .startingBonusPointId(ride.getStartingBonusPointId())
                .endingBonusPointId(ride.getEndingBonusPointId())
                .name(ride.getName())
                ...
                .odometerStart(ride.getOdometerStart())
