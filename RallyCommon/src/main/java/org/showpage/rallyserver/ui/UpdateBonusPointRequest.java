...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request to update an existing bonus point")
public class UpdateBonusPointRequest {
    @Schema(description = "Unique code for this bonus point", example = "BP001")
    private String code;

    @Schema(description = "Bonus point name", example = "Statue of Liberty")
    private String name;
